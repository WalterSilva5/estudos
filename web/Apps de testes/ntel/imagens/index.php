...
<body>
    <!-- barra de navegação-->
    <nav class="navbar navbar-expand-md navbar-light mb-2" style="background-color: #e3f2fd;">
        <div class="container">
  ...
  <div id="div_conteudo">
    <!-- galeria de preços -->
<!-- galeria de preços -->
<div class="galeria text-center col-md-12  ">
  <p class="h1" >QUAL O MELHOR PLANO PARA VOCE?</p>

  <form action="cadastro.php" method="post">
  <div class="row">
    <div class="recuar bg-light col-md-4">
        <button type="submit" name="plano" value="3mb" class="btn btn-light border-0"><img  class="img-responsive anuncio" src="imagens/planos/3mb.png" alt="3mb"></button>
    </div>
    <div class="recuar bg-light col-md-4">
        <button type="submit" name="plano" value="4mb" class="btn btn-light border-0"><img  class="img-responsive anuncio" src="imagens/planos/4mb.png" alt="4mb"></button>
    </div>
    <div class="recuar bg-light col-md-4">
        <a href="planos.php"  class="btn btn-light border-0"><img  class="img-responsive anuncio" src="imagens/planos/vmb.png" alt="5mb"></a>
    </div>
  </form>
</div>
   ...
   <footer id="rodape">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            <img class="img-logo" src="imagens/ntel-logo.png" alt="NTEL Telecom">
          </div>
