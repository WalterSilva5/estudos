...
<form action="cadastro.php" method="post">
    ...
    <p class="h1" style="font-family: 'Rammetto One', cursive;" >Qual o Melhor Plano Para Você?</p>
    ...
    <button type="submit" name="plano" value="4mb" class="btn btn-light botao col-md-3"><img  class="img-fluid anuncio" src="imagens/planos/4mb.png" alt="4mb"></button>
    <a href="planos.php" class="btn btn-light botao col-md-3"><img  class="img-fluid anuncio" src="imagens/planos/vmb.png" alt="vmb"></a>
    </div>
</form>
</div>
