...
For more on this new functionality, see **[session options](https://github.com/ArturoDent/launch-config/blob/master/options.md)**.
...
<!-- ![Settings.json Intellisense](https://github.com/ArturoDent/launch-config/raw/master/images/launchesSettingsIntellisense.gif) -->
...
This setting controls how to handle a currently running debug session when triggering the same keybinding again for that launch configuration.   See more at **[session options](https://github.com/ArturoDent/launch-config/blob/master/options.md)**.   
...
<!-- ![Keybindings shortcuts](https://github.com/ArturoDent/launch-config/raw/master/images/shortcuts.gif) -->
...
<!-- ![QuickPick panel](https://github.com/ArturoDent/launch-config/raw/master/images/LaunchQuickPick.gif) -->
...
```jsonc
  ...
  * Note: see **[session options](https://github.com/ArturoDent/launch-config/blob/master/options.md)** for more on using args in a keybinding.


<!-- ![Intellisense for Keybindings.json](https://github.com/ArturoDent/launch-config/raw/master/images/keybindingsIntellisense.gif) -->
